...
<head>
    ...
    <title>Kaldu Kokot 76 Khas Pamekasan</title>
</head>
...
<body>
    ...
    <div class="main-content" id="app">
        <div class="background-img" data-src="assets/img/kaldu-kokot.jpg" style="background-size: cover;background-position: top center; height:705px; position: absolute; width: 100%;">
        </div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>Kaldu Kokot 76 Khas Pamekasan</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="detail-content">
                        <h3 class="title-content">Kaldu Kokot 76 Khas Pamekasan</h3>
                        <p><span class="icon-blue"><i class="fa fa-map-marker-alt"></i></span>Jl. Trunojoyo, Patemon, Kec. Pamekasan, Kabupaten Pamekasan, Jawa Timur 69317</p>
                        <h5 class="title-section">Informasi Kaldu Kokot 76</h5>
                    ...
                    <aside>
                        <div class="side-bar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <a href="https://www.google.com/maps/place/Kaldu+Kokot+76+Khas+Pamekasan/@-7.1660735,113.4814984,15z/data=!4m5!3m4!1s0x0:0xb6a1358fe572b36d!8m2!3d-7.1660735!4d113.4814984">
                                        <div class="capt-info">Jl. Trunojoyo, Patemon, Kec. Pamekasan, Kabupaten Pamekasan, Jawa Timur 69317</div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">09:00 - 22:00</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">+6287750460922</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">
                                        <a target="_blank" href="https://www.instagram.com/kaldukokot76/">https://www.instagram.com/kaldukokot76/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
