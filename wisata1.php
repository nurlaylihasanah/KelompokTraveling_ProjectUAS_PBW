...
<body>
    ...
    <div class="main-content" id="app">
        <div class="background-img" data-src="assets/img/wisata/danaubiru.jpg" style="background-size: cover;background-position: top center; height:705px; position: absolute; width: 100%;">
        </div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>Danau Biru Jaddih</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="detail-content">
                        <h3 class="title-content">Danau Biru Jaddih</h3>
                        <p><span class="icon-blue"><i class="fa fa-map-marker-alt"></i></span>Jakan, Parseh, Socah, Kabupaten Bangkalan, Jawa Timur 69161</p>
                        <h5 class="title-section">Informasi Danau Biru Jaddih</h5>
                        <div class="info-article">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <p><i class="fa fa-utensils"></i> Wisata</p>
                                </div>
                                <div class="col-md-6 col-12">
                        ...
                        <div class="info-article">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Rp. 10000</p>
                                </div>
                            </div>
                        </div>
                        <h5 class="title-section">Ulasan Tentang Danau Biru</h5>
                        <div class="row mb-2">
                            <div class="col-md-2">
                                <h1 class="val-rate">4.1</h1>
                            </div>
                            <div class="col-md-7">
                    ...
                    <aside>
                        <div class="side-bar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <a href="https://www.google.com/maps/place/Danau+Biru+Bukit+Jaddih/@-7.0821033,112.7599131,15z/data=!4m5!3m4!1s0x0:0xa54eb5c9d41119c4!8m2!3d-7.0821033!4d112.7599131">
                                        <div class="capt-info">Jakan, Parseh, Socah, Kabupaten Bangkalan, Jawa Timur 69161</div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">06:00 - 17:00</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">+6287849652145</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">
                                        <a target="_blank" href="https://www.instagram.com/danaubiru/">https://www.instagram.com/danaubiru/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
