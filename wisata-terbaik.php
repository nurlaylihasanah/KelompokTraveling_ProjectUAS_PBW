...
<!-- Required meta tags -->
    ...
    <title>Wisata-Terbaik-Madura</title>
</head>
<body>
    ...
    <div class="main-content">
        ...
        <div class="banner-top">
            <img src="assets/img/wisata/wisata-terbaik.jpg" class="img-fluid">
            <div class="overlay-img">
                <h3>Wisata Terbaik di Madura</h3>
            </div>
        </div>
                    ...
                    <div class="detail-content">
                        <div class="row" id="list">
                            <?php
                              ...
                              $tampil_berita_cerita = $conn->query("SELECT * FROM tb_wisata");
                              while($data = mysqli_fetch_array($tampil_berita_cerita)){
                              ?>
                            <div class="col-md-3">
                                <div class="card-list">
                                    <a href="#">
                                    	<img src="assets/img/wisata/<?php echo $data['gambar'];?>" class="img-fluid featured-img mb-2">
                                        <h5 class="s-img-title"><?php echo $data['nama_wisata']; ?></h5>
                                    </a>
                                    <span class="icon-blue"><i class="fa fa-map-marker-alt"></i><?php echo $data['lokasi_wisata']; ?></span>
                                    <div class="mt-2">
