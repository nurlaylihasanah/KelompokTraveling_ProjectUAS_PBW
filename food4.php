...
<head>
    ...
    <title>Warung Ibu Adnan Kaldu Kokot</title>
</head>
...
<body>
    ...
    <div class="main-content" id="app">
        <div class="background-img" data-src="assets/img/kaldu-sumenep.jpg" style="background-size: cover;background-position: top center; height:705px; position: absolute; width: 100%;">
        </div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>Warung Ibu Adnan Kaldu Kokot</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="detail-content">
                        <h3 class="title-content">Warung Ibu Adnan Kaldu Kokot</h3>
                        <p><span class="icon-blue"><i class="fa fa-map-marker-alt"></i></span>Jl. DR. Wahidin No.5, Lingkungan Delama, Pajagalan, Kotasumenep, Kabupaten Sumenep, Jawa Timur 69416</p>
                        <h5 class="title-section">Informasi Warung Ibu Adnan Kaldu Kokot</h5>
                        <p>Menyediakan makanan kaldu kokot</p>
                        ...
                        <div class="info-article">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Antara Rp. 12000 - Rp. 18000</p>
                                </div>
                            </div>
                        </div>
                        <h5 class="title-section">Ulasan Tentang Warung Ibu Adnan</h5>
                        <div class="row mb-2">
                            <div class="col-md-2">
                                <h1 class="val-rate">4.3</h1>
                            </div>
                            <div class="col-md-7">
                    ...
                    <aside>
                        <div class="side-bar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <a href="https://www.google.com/maps/place/Warung+Ibu+Adnan+Kaldu+Kokot/@-7.0101576,113.8618735,15z/data=!4m5!3m4!1s0x0:0x43a0415cfd303f1d!8m2!3d-7.0101576!4d113.8618735">
                                        <div class="capt-info">Jl. DR. Wahidin No.5, Lingkungan Delama, Pajagalan, Kotasumenep, Kabupaten Sumenep, Jawa Timur 69416</div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">05:00 - 17:00</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">(0328)665387</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">
                                        <a target="_blank" href="https://www.instagram.com/kaldukokotibuadnan/">https://www.instagram.com/kaldukokotibuadnan/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
