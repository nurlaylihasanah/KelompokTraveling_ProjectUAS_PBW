...
<head>
    ...
    <title>Bebek Sinjay Madura</title>
</head>
...
<body>
    ...
    <div class="main-content" id="app">
        <div class="background-img" data-src="assets/img/kuliner/bannerbebek.jpg" style="background-size: cover;background-position: top center; height:705px; position: absolute; width: 100%;">
        </div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>Bebek Sinjay Madura</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="detail-content">
                        <h3 class="title-content">Bebek Sinjay Madura</h3>
                        <p><span class="icon-blue"><i class="fa fa-map-marker-alt"></i></span>Jl. Raya Ketengan No.45, Junok, Tunjung, Kec. Burneh, Kabupaten Bangkalan, Jawa Timur 69121</p>
                        <h5 class="title-section">Informasi Bebek Sinjay Madura</h5>
                        <p>Menyediakan aneka olahan bebek.</p>
                        <div class="info-article">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Bangkalan</p>
                                </div>
                            </div>
                        </div>
                        <div class="info-article">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Antara Rp. 18000 - Rp. 25000</p>
                                </div>
                            </div>
                        </div>
                        <h5 class="title-section">Ulasan Tentang Bebek Sinjay</h5>
                        <div class="row mb-2">
                            <div class="col-md-2">
                    ...
                    <aside>
                        <div class="side-bar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <a href="https://www.google.com/maps/place/Bebek+Sinjay+Madura/@-7.0382948,112.7662286,17z/data=!3m1!4b1!4m5!3m4!1s0x2dd80576c84a54d3:0xfb25a1b85558795c!8m2!3d-7.0382948!4d112.7684173" target="_blank">
                                        <div class="capt-info">Jl. Raya Ketengan No.45, Junok, Tunjung, Kec. Burneh, Kabupaten Bangkalan, Jawa Timur 69121</div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">07:00 - 17:00</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">+6287849655545</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">
                                        <a target="_blank" href="https://www.instagram.com/bebeksinjaymadura/">https://www.instagram.com/bebeksinjaymadura/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
