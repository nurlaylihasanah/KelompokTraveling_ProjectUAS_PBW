...
<head>
    ...
    <title>Museum Keraton Sumenep</title>
</head>
...
<body>
    ...
    <div class="main-content" id="app">
        <div class="background-img" data-src="assets/img/galeri/keratonsumenep.jpg" style="background-size: cover;background-position: top center; height:705px; position: absolute; width: 100%;">
        </div>
        <section class="container mt-130">
            <div class="row">
                    ...
                    <div class="bc-custom">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="obyekwisata.php">Wisata</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>Museum Keraton Sumenep</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="detail-content">
                        <h3 class="title-content">Museum Keraton Sumenep</h3>
                        <p><span class="icon-blue"><i class="fa fa-map-marker-alt"></i></span>Jl. Dr. Sutomo No.6, Lingkungan Delama, Pajagalan, Kotasumenep, Kabupaten Sumenep, Jawa Timur 69416</p>
                        <h5 class="title-section">Informasi Museum Keraton Sumenep</h5>
                        <div class="info-article">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <p><i class="fa fa-utensils"></i> Museum</p>
                                </div>
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Sumenep</p>
                                </div>
                            </div>
                        </div>
                        <div class="info-article">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Antara Rp. 10000 - Rp. 20000</p>
                                </div>
                            </div>
                        </div>
                        <h5 class="title-section">Ulasan Tentang Museum Keraton Sumenep</h5>
                        <div class="row mb-2">
                            <div class="col-md-2">
                                <h1 class="val-rate">4.6</h1>
                            </div>
                            <div class="col-md-7">
                ...
                <div class="col-md-4">
                    <aside>
                        <div class="side-bar">
                            <h5 class="title-section">Info Wisata</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <a href="https://www.google.com/maps/place/Museum+Keraton+Sumenep/@-7.0081214,113.8628473,15z/data=!4m5!3m4!1s0x0:0x392c4cc621a3b3cd!8m2!3d-7.0081214!4d113.8628473">
                                        <div class="capt-info">Jl. Dr. Sutomo No.6, Lingkungan Delama, Pajagalan, Kotasumenep, Kabupaten Sumenep, Jawa Timur 69416</div>
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">07:00 - 15:30</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">(0328)55</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">
                                        <a target="_blank" href="https://www.instagram.com/keraton/">https://www.instagram.com/keraton/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
