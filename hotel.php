...
<head>
    ...
    <title>Cahaya Berlian Hotel</title>
</head>
...
<body>
    ...
    <div class="main-content" id="app">
        <div class="background-img" data-src="assets/img/akomodasi/akomodasi.jpg" style="background-size: cover;background-position: top center; height:705px; position: absolute; width: 100%;">
        </div>
        <section class="container mt-130">
            <div class="row">
                    ...
                    <div class="bc-custom">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="akomodasi.php">Akomodasi</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span>Cahaya Berlian Hotel</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="detail-content">
                        <h3 class="title-content">Cahaya Berlian Hotel</h3>
                        <p><span class="icon-blue"><i class="fa fa-map-marker-alt"></i></span>Jl. Raya Panglegur No.69 - 71, Barat, Panglegur, Tlanakan, Kabupaten Pamekasan, Jawa Timur 69371</p>
                        <h5 class="title-section">Informasi Cahaya Berlian Hotel</h5>
                        <p>Kamar yang luas tertata apik dengan furniture yang elegan, desain interior tematik pada masing-masing kamar, pemandangan suasana pedesaan, bersih dan higienis, staff yang ramah-sopan dan cekatan menjadikan paduan lengkap kenyamanan tinggal anda.</p>
                        <div class="info-article">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <p><i class="fa fa-utensils"></i> Akomodasi</p>
                                </div>
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Pamekasan</p>
                                </div>
                            </div>
                        </div>
                        <div class="info-article">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <p><i class="fa fa-money-bill"></i>Kisaran Harga</p>
                                </div>
                                <div class="col-md-6 col-12">
                                    <p class="text-right">Rp. 300.000 - Rp. 375.000</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <ul class="row detail-list">
                                <li class="col-md-4">Wi-Fi Gratis</li> 
                                <li class="col-md-4">Penyejuk Udara</li> 
                                <li class="col-md-4">TV Cable</li> 
                                <li class="col-md-4">Restoran</li>
                                <li class="col-md-4">Coffee Shop</li>
                                <li class="col-md-4">Drug Store</li>
                            </ul>
                        </div>
                        <h5 class="title-section">Ulasan Tentang Cahaya Berlian Hotel</h5>
                        <div class="row mb-2">
                            <div class="col-md-2">
                                <h1 class="val-rate">4.4</h1>
                            </div>
                            <div class="col-md-7">
                ...
                <div class="col-md-4">
                    <aside>
                        <div class="side-bar">
                            <h5 class="title-section">Info Akomodasi</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <a href="https://www.google.com/maps/place/Cahaya+Berlian+Hotel/@-7.1872464,113.4776101,15z/data=!4m5!3m4!1s0x0:0xafbdf8a5f9bdc7be!8m2!3d-7.1872464!4d113.4776101">
                                        <div class="capt-info">Jl. Raya Panglegur No.69 - 71, Barat, Panglegur, Tlanakan, Kabupaten Pamekasan, Jawa Timur 69371</div>
                                        <div class="sub-title-info"> Powered by Here.com maps </div>
                                    </a>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    <div class="capt-info">Jam Check In</div>
                                    <div class="sub-title-info">10:00 - 19:00</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">+62 324 351 0652</div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="sub-title-info">
                                        <a target="_blank" href="https://www.instagram.com/cahayaberlianhotel/">https://www.instagram.com/cahayaberlianhotel/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
